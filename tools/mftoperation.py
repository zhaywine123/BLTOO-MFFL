...
OPS = {
    ...
    "spa_sec_3" : lambda C_in, C_out, stride, affine, track_running_stats: nn.Sequential(
        nn.ReLU(inplace=False),
        nn.Conv2d(C_in, C_in, (1, 3), stride=(1, stride), padding=(0, 1), bias=False),
        nn.Conv2d(C_in, C_in, (3, 1), stride=(stride, 1), padding=(1, 0), bias=False),
        nn.BatchNorm2d(C_in, affine=affine)
    ),
    "spa_sec_5" : lambda C_in, C_out, stride, affine, track_running_stats: nn.Sequential(
        nn.ReLU(inplace=False),
        nn.Conv2d(C_in, C_in, (1, 5), stride=(1, stride), padding=(0, 2), bias=False),
        nn.Conv2d(C_in, C_in, (5, 1), stride=(stride, 1), padding=(2, 0), bias=False),
        nn.BatchNorm2d(C_in, affine=affine)
    ),
